...
# Implementation Status: ✓ Done (Round 8: /config editor - wider cards, smaller icon buttons, angled connections, fixed Templates/Snapshots dialog, on top of Round 7's expand-button fix, Round 6's scrim fix, Round 5's Save-button fix, Round 4's History modal fixes and Round 3's A-F corrections)
