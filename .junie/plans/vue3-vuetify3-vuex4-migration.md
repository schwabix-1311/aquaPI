...
# Implementation Status: ✓ Done (Round 7: History widget expand button no longer round, plus reduced horizontal padding, on top of Round 6's scrim fix, Round 5's Save-button fix, Round 4's History modal fixes and Round 3's A-F corrections)
