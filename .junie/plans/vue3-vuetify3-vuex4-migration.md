...
# Implementation Status: ✓ Done (Round 6: dashboard configurator scrim fixed to the viewport instead of scrolling with the page, on top of Round 5's Save-button fix, Round 4's History modal fixes and Round 3's A-F corrections)
