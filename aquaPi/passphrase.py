...
WORDS = {
    "de": [
        ...
        "wels", "zander", "skalar", "kampffisch", "guppy", "auge", "bauch", "fettflosse", "flosse",
        "kieme", "goldfisch", "maul", "panzer", "rücken", "saugnapf", "schnauze", "schuppe",
        "schwanz", "neon", "weich", "zahn", "zunge", "zwerg", "bunt", "muster", "farn", "fels",
        "glas", "grund", "höhle", "holz", "kies", "kraut", "laub", "moos", "pflanze", "riff",
        "rohr", "sand", "stein", "barbe", "sumpf", "wurzel", "wrack", "zweig", "becken", "wand",
        "boden", "untergrund", "rand", "bach", "blau", "dampf", "druck", "eis", "flocke", "fluss",
        "flussbett", "frisch", "frost", "seepferdchen", "grad", "grün", "hafen", "kalt",
        "kälte", "klar",
        ...
        "zone", "eimer", "filter", "futter", "haken", "kabel", "kescher", "klemme", "forelle",
        "lampe",
        "licht", "netz", "pumpe", "sauger", "schlauch", "sieb", "skimmer", "spachtel", "spüler",
        "stecker", "test", "timer", "aal", "uhr", "ventil", "ventilator", "waage", "wolle",
        "zange", "zuleitung", "zulauf", "ablauf", "pflegemittel", "bürste", "stichling",
        ...
        "saugen", "schwimmen", "sinken", "spülen", "sprudeln", "spritzen", "steigen", "strömen",
        "tauchen", "treiben", "untergehen", "waten", "wechseln", "weiden", "salmler", "zucken",
        "züchten"
    ],
    "en": [
        ...
        "urchin", "whale", "zebra", "belly", "claw", "betta", "eyeball", "barb", "fang", "fin",
        "gill", "jaw", "mouth", "pincer", "scale", "shell", "snout", "spine", "tail", "tentacle",
        "tooth", "goldfish", "whiskers", "arch", "bark", "basin", "bed", "bottom", "branch",
        "bridge", "cave", "clay", "driftwood", "fern", "flora", "glass", "gravel", "discus",
        ...
        "mist", "motion", "ocean", "koi", "pond", "pool", "pure", "rain", "river", "salt", "sea",
        "shade", "shine", "shore", "steam", "stream", "tide", "tint", "vapor", "warm", "water",
        "wave", "wet", "zone", "bucket", "cable", "clip", "cooler", "drain", "feed", "filter",
        "gauge", "grid", "heater", "hose", "tubing", "light", "mesh", "meter", "net", "nozzle",
        ...
        "roam", "rush", "eel", "skim", "soak", "splash", "spray", "catfish", "swim", "swirl",
        "track", "wade", "wash"
    ]
}
