...
- Run `node --input-type=module --check` over all modified `.js` files.
- Update `.junie/plans/project-clarification-and-test-plan.md` to mark Step 18 as done, documenting the registry/EventBus/lifecycle-hook approach actually implemented.